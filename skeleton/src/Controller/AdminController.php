...
class AdminController extends AbstractController
{
    ...
    public function listQuestions(EntityManagerInterface $em): Response
    {
        ...
        //ocupamos array map para filtrar las categorias y enviarlas a la vista
    ...
    public function listTrivias(EntityManagerInterface $em): Response
    {
        $trivias = $em->getRepository(Trivia::class)->findAll();
        $data = array_map(function (Trivia $t) {
            return ['id' => $t->getId(), 'name' => $t->getName(), 'questions' => $t->getQuestions()->toArray()];
        }, $trivias);
        
        $parameters['trivias'] = $data;
        $parameters['questions'] = $em->getRepository(Question::class)->findAllOrderedByCategoryAndId();
    ...
    public function listAnswers(EntityManagerInterface $em): Response
    {
